...
const CAPI_DATA = {
  recipes: {
    ...
    "olla-pollo": {
      ...
      steps: [
        "🔁 Esta olla rinde 2 almuerzos (lunes · martes). Cantidades para toda la olla, no por plato.",
    ...
    "olla-lentejas": {
      ...
      steps: [
        "🔁 Esta olla rinde 2 almuerzos (miércoles · jueves). Cocínala el martes en la tarde o el miércoles.",
        ...
        "Reparte en 2 tandas a la nevera. Cada día recalientas una en ollita con un chorrito de agua + arroz fresco.",
        "Si al hijo no le convencen, un huevo duro picado encima las salva. 🦫",
      ],
      nutri: { e: "~540 kcal · 26 g proteína por plato" },
    },
    "olla-carne": {
      t: "Olla grande de carne con verduras", emoji: "🍲", time: "35 min (una sola vez)",
      ing: [
        { n: "Carne molida 5% grasa", e: "500 g (toda la olla)", h: "500 g (toda la olla)" },
        { n: "Papa, zanahoria y zapallo en cubos", e: "4 tazas", h: "4 tazas" },
        { n: "Choclo y arvejas", e: "1 taza", h: "1 taza" },
        { n: "Cebolla, ajo y pimentón (sofrito)", e: "1 cda de aceite para toda la olla", h: "1 cda de aceite para toda la olla" },
        { n: "Arroz o tallarines para acompañar (al servir)", e: "1 puñado por plato", h: "1 puñado por plato" },
      ],
      steps: [
        "🔁 Esta olla rinde 2 almuerzos (viernes · sábado). Cocínala el jueves en la tarde o el viernes.",
        "Dora la carne sin aceite (suelta su propia grasa, escúrrela) con el sofrito.",
        "Agrega las verduras y agua o caldo que cubra. 15–20 min hasta que estén blandas.",
        "Reparte en 2 tandas a la nevera. Cada día recalientas una en ollita con un chorrito de agua.",
        "El viernes va como guiso; el sábado, si quieres, con tallarines (queda como boloñesa). 🦫",
      ],
      nutri: { e: "~540 kcal · 30 g proteína por plato" },
    },
  ...
  weeks: [
    ...
    },
    {
      ...
      rules: [
        "El gran cambio: cocinas 3 veces en la semana, no 7. Cada olla rinde 2 almuerzos (más fresco que 3 días).",
        ...
        "Las 3 ollas (pollo, lentejas, carne) rinden 2 días cada una; el domingo es la pizza. Si un día no quieres cocinar, adelanta la siguiente olla — tú mandas.",
        "Nada frito (la vesícula manda), grasas en cucharaditas, y la pizza del domingo es plan, no pecado. 🦫",
      ],
      prep: {
        title: "Cocinas 3 veces, no 7 (cada olla, 2 días)",
        items: [
          "DOMINGO: la olla grande de pollo (rinde lun-mar) + la masa y salsa de la pizza + 4 huevos duros para las onces.",
          "MARTES en la tarde (o el miércoles): la olla grande de lentejas (rinde mié-jue).",
          "JUEVES en la tarde (o el viernes): la olla grande de carne (rinde vie-sáb).",
          "Reparte cada olla en 2 cajas tapadas apenas se entibie y a la nevera. Cada día solo recalientas.",
      ...
      days: [
        ...
        { name: "Miércoles", desayuno: "porridge-platano", almuerzo: "olla-lentejas", once: "once-atun" },
        { name: "Jueves",    desayuno: "huevos-marraqueta",almuerzo: "olla-lentejas", once: "once-huevo" },
        { name: "Viernes",   desayuno: "licuado-platano",  almuerzo: "olla-carne",    once: "once-pavo" },
        { name: "Sábado",    desayuno: "yogur-bowl",       almuerzo: "olla-carne",    once: "once-quesillo" },
      ...
      shopping: [
        ...
        },
        {
          ...
          items: [
            ...
            { n: "Lentejas", q: "500 g" },
            { n: "Carne molida 5% grasa", q: "500 g" },
